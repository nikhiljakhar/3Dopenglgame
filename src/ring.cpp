...
Ring::Ring(float x, float y, float z) {
    ...
    GLfloat vertex_buffer_data[4*n*18] = {};
    ...
    this->object = create3DObject(GL_TRIANGLES, 4*n*6, vertex_buffer_data, COLOR_WHITE, GL_FILL);
    this->object2 = create3DObject(GL_TRIANGLES, 4*n*6, vertex_buffer_data, COLOR_PGREEN, GL_FILL);
    this->object3 = create3DObject(GL_TRIANGLES, 4*n*6, vertex_buffer_data, COLOR_RED, GL_FILL);
}
